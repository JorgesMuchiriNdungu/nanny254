...
require_once "checklogin.php";
  ...
  $spot_users = "SELECT parents.first_name,parents.last_name,parents.phoneno,parents.email FROM parents INNER JOIN nannies ON parents.first_name = nannies.employer";
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="exampleModal">
                    <form action="employerupdate.php" method="post" class="p-3" enctype="multipart/form-data">
                       <fieldset>
