       ...
       <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="viewnannies.php"><i class="fa fa-circle-o"></i>View Nannies</a></li>
                <li><a href="nhif.php"><i class="fa fa-circle-o"></i>View Nannies</a></li>           
...
$result_spot_users = $conn->query($spot_users);
  ...
  ?>
        <tr> 
           <td><?php echo $spot_users_row["userId"]; ?></td>
 ...
 <td>  <a href="edit1.php?userId=<?php echo $spot_users_row["userId"]; ?>">


 <span class="edit" title="Edit"> <i class="fa fa-camera"></i> </span></a>
     
      <a href="delete.php?userId=<?php echo $spot_users_row["userId"]; ?>" 
...
?>
  ...
  <footer class="main-footer">
   ...
   <strong>Copyright &copy; 2018 <a href="#">Nanny 254</a>.</strong> All rights reserved.
  </footer>
