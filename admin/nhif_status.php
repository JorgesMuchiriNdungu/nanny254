 ...
 <li class="dropdown user user-menu">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3 class="box-title">NHIF Membership Status Report</h3>
      <ol class="breadcrumb">
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  data: [{
    ...
    dataPoints: [
      ...
      { y: <?php echo number_format((nhif()/nannies()),2)*100;?>, label: "Nannies with NHIF membership" },
      { y: <?php echo number_format((nonhif()/nannies()),2)*100;?>, label: "Nannies without NHIF membership" }
