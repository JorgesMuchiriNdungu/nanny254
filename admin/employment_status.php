...
<li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3 class="box-title">Employment Status Report</h3>
      <ol class="breadcrumb">
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  data: [{
    ...
    dataPoints: [
      ...
      { y: <?php echo number_format((employed()/nannies()),2)*100;?>, label: "Employed" },
      { y: <?php echo number_format((unemployed()/nannies()),2)*100;?>, label: "Unemployed" }
...
chart.render();
 ...
 Employed Nannies = <?php echo employed()?><br>
 Unemployed Nannies = <?php echo unemployed()?>
