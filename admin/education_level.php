...
<li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3 class="box-title">Nannies Education Level Status Report</h3>
      <ol class="breadcrumb">
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  data: [{
    ...
    dataPoints: [
      ...
      { y: <?php echo number_format((primary()/nannies()),2)*100;?>, label: "Primary" },
      { y: <?php echo number_format((secondary()/nannies()),2)*100;?>, label: "Secondary" },
      { y: <?php echo number_format((college()/nannies()),2)*100;?>, label: "College" },
      { y: <?php echo number_format((university()/nannies()),2)*100;?>, label: "University" }
