                    ...
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li>
                            <button type="button" class="btn  ml-lg-2 w3ls-btn" data-toggle="modal" aria-pressed="false"
                                ...
                                <i class="far fa-user-circle"></i>Nanny
                            </button>
                        </li><li>
                            <button type="button" class="btn  ml-lg-2 w3ls-btn" data-toggle="modal" aria-pressed="false"
    ...
    <div class="about-w3sec py-sm-5" id="about">
        <div class="container py-5">
            <div class="title-section pb-4">
                <h3 class="main-title-agile">Membership Payment</h3>
                <span class="title-line">
                </span>
            </div>

<?php
                              include "pesapal/pesapal-iframe.php";
                              ?>
                    ...
                    <div class="main-timeline2">
                        <div class="timeline">
                            ...
                            <a href="#" class="timeline-content">
                                <h3 class="main-title-agile">Father</h3>
                                <p class="main-title-agile">
                                   <?php echo $spot_users_row["father_id"]; ?>
                                </p>
                            </a>
                        ...
                        <div class="timeline">
                            ...
                            <a href="#" class="timeline-content">
                                <h3 class="main-title-agile">Mother</h3>
                                <p class="main-title-agile">
                                     <?php echo $spot_users_row["mother_id"]; ?>
                                </p>
                            </a>
                      </div>
                   </div>
...
$result_spot_users1 = $conn->query($spot_users1);
    if($result_spot_users1->num_rows >0){
        while($spot_users_row1 = $result_spot_users1->fetch_assoc()){
    ?><div class="main-timeline2">
                   
                   <div class="timeline">
                            <span class="icon fa fa-rocket"></span>
                            <a href="#" class="timeline-content">
                                <h3 class="title">Sisters</h3>
                                <p class="description">
                                    <?php echo $spot_users_row1["name"]; ?>
                                </p>
                            </a>
