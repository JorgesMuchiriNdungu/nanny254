        ...
        <div class="container">
            <div class="banner-text">
                <div class="slider-info">
                    <h3>Whatever house keeping services you need, we've got you covered</h3>
    ...
    <div class="about-w3sec py-sm-5" id="about">
        <div class="container py-5">
            <div class="title-section pb-4">
                <h3 class="main-title-agile">Find Best Nanny </h3>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Find Best Nanny</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 footv4-content mt-sm-0 mt-4">
                        ...
                        <ul class="v4-content">
                            ...
                            <li>
                                <a href="#work" class="scroll">Services </li>
                            <li>
                ...
                <div class="modal-body">
                    <form action="payment.php" method="post" class="p-3">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder=" " name="full_name" id="recipient-rname"
                                required="">
                        </div>   <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Phone Number</label>
                            <input type="text" class="form-control" placeholder=" " name="phone_number" id="recipient-rname"
                                required="">
                        </div>
                        <div class="form-group">
