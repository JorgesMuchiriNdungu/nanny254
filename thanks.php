...
$spot_users  = "SELECT * from parents where first_name = '$id'";
    ...
    <div class="contact-wthree" id="contact">
        <div class="container py-sm-5">
            <div class="title-section py-4">
                <h3 class="main-title-agile">Nanny Rating</h3>
...
<body>
 <h3 class="main-title-agile"><?php echo $_SESSION['authlog']['first_name']?> Thanks for rating your Nanny</h3>
